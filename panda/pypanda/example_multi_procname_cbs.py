...
if not path.isfile("toy-rr-snp"):
    @blocking
    def run_toy():
        panda.record_cmd("toy-test/toy toy-test/testsmall.bin", "toy-test", recording_name="toy")
        panda.stop_run()
...
panda.run_replay("toy_small") # Generated by hand with scissors from toy

print("TOY:", hit_toy)
print("ATA:", hit_ata)
print("ALL:", hit_always)
assert (hit_toy and hit_ata and hit_always)
